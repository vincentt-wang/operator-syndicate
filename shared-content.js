...
window.OS_CONTENT = {
  ...
  brand: {
    ...
    positioning_zh: "全台首創 Operator-Led 投資飛輪。我們為放大你的營收而生——從打進企業，到突破規模天花板，靠的是 50+ 位走過這條路的營運者。",
  ...
  operators: [
    {id:1, name:'James C.',    company:'Google',      companyKey:'nexia',   color:'#4285F4', title:'VP, Enterprise Solutions',        years:8,  focus:'Cloud · Enterprise SaaS', linkedin:'', fn:'Enterprise Sales', type:'Founding Council', visible:true},
    {id:2, name:'Michelle L.', company:'Microsoft',      companyKey:'nexia',   color:'#0EA5E9', title:'Director, Global Strategic Accounts', years:6, focus:'Strategic Partnerships', linkedin:'', fn:'Enterprise Sales', type:'Founding Council', visible:true},
    {id:3, name:'Sarah K.',    company:'NVIDIA',      companyKey:'nexia',   color:'#76B900', title:'VP, Strategic Partnerships APAC', years:7,  focus:'APAC · B2B SaaS', linkedin:'', fn:'Partnerships', type:'Founding Council', visible:true},
    {id:4, name:'Ryan H.',     company:'AWS',      companyKey:'nexia',   color:'#FF9900', title:'Director, Cloud Business',        years:5,  focus:'Cloud Infrastructure', linkedin:'', fn:'Cloud & Infra', type:'Founding Council', visible:true},
    {id:5, name:'Amy T.',      company:'Salesforce',      companyKey:'nexia',   color:'#14B8A6', title:'VP, Business Development Asia',   years:9,  focus:'Market Expansion · Asia', linkedin:'', fn:'Growth & BD', type:'Founding Council', visible:true},
    {id:6, name:'Patrick L.',  company:'Oracle',    companyKey:'oracore', color:'#EF4444', title:'Director, Regional Sales APAC',   years:9,  focus:'Database · Enterprise', linkedin:'', fn:'Enterprise Sales', type:'Founding Council', visible:true},
    {id:7, name:'Wayne C.',    company:'SAP',    companyKey:'oracore', color:'#6366F1', title:'VP, Database & Cloud Solutions',  years:11, focus:'Cloud Migration · SaaS', linkedin:'', fn:'Cloud & Infra', type:'Founding Council', visible:true},
    {id:8, name:'Yvonne M.',   company:'TSMC',    companyKey:'oracore', color:'#DC2626', title:'VP, Enterprise Accounts',         years:8,  focus:'Enterprise Accounts', linkedin:'', fn:'Enterprise Sales', type:'Founding Council', visible:true},
    {id:9, name:'David T.',    company:'Foxconn',    companyKey:'oracore', color:'#2563EB', title:'Director, Channel Partners',      years:6,  focus:'Channel · Resellers', linkedin:'', fn:'Channel', type:'Founding Council', visible:true},
    {id:10,name:'Henry C.',    company:'MediaTek',    companyKey:'globex',  color:'#F97316', title:'VP, Cloud Infrastructure',        years:10, focus:'Cloud · AI/ML', linkedin:'', fn:'Cloud & Infra', type:'Founding Council', visible:true},
    {id:11,name:'Emma M.',     company:'Delta',    companyKey:'globex',  color:'#06B6D4', title:'Director, B2B Partnerships',      years:5,  focus:'B2B · Developer Tools', linkedin:'', fn:'Partnerships', type:'Founding Member', visible:true},
    {id:12,name:'Kevin W.',    company:'Chunghwa Telecom',    companyKey:'globex',  color:'#EAB308', title:'Director, Startup Ecosystem',     years:6,  focus:'Startups · GTM', linkedin:'', fn:'Growth & BD', type:'Founding Member', visible:true},
    {id:13,name:'Lisa N.',     company:'Fubon',    companyKey:'globex',  color:'#059669', title:'Director, Partner Strategy',      years:7,  focus:'Partner Ecosystem', linkedin:'', fn:'Partnerships', type:'Founding Member', visible:true},
    {id:14,name:'Ben K.',      company:'Cathay',    companyKey:'globex',  color:'#10B981', title:'VP, Enterprise Sales APAC',       years:12, focus:'Enterprise Sales · APAC', linkedin:'', fn:'Enterprise Sales', type:'Founding Member', visible:true},
    {id:15,name:'Thomas C.',   company:'ASUS',       companyKey:'acs',     color:'#3B82F6', title:'VP, Startup Programs',            years:7,  focus:'Startups · Cloud Credits', linkedin:'', fn:'Growth & BD', type:'Founding Member', visible:true},
    {id:16,name:'Grace S.',    company:'Acer',       companyKey:'acs',     color:'#84CC16', title:'Director, Enterprise Solutions',  years:8,  focus:'Enterprise Solutions', linkedin:'', fn:'Enterprise Sales', type:'Founding Member', visible:true},
    {id:17,name:'Michael R.',  company:'Quanta',       companyKey:'acs',     color:'#0891B2', title:'VP, Channel Partnerships',        years:10, focus:'Channel · ISV', linkedin:'', fn:'Channel', type:'Founding Member', visible:true},
    {id:18,name:'Nancy P.',    company:'Pegatron',       companyKey:'acs',     color:'#A855F7', title:'Director, Cloud Sales APAC',      years:6,  focus:'Cloud Sales · APAC', linkedin:'', fn:'Cloud & Infra', type:'Founding Member', visible:true},
    {id:19,name:'Frank Y.',    company:'Uni-President',companyKey:'others',  color:'#E11D48', title:'VP, Digital Transformation',     years:9,  focus:'Digital Transformation', linkedin:'', fn:'Growth & BD', type:'Founding Member', visible:true},
    {id:20,name:'Alex L.',     company:'CTBC', companyKey:'others',  color:'#8B5CF6', title:'Director, Enterprise APAC',       years:8,  focus:'Enterprise Sales', linkedin:'', fn:'Enterprise Sales', type:'Founding Member', visible:true},
