...
window.OS_CONTENT = {
  ...
  brand: {
    ...
    tagline_zh_1: "不只是投資",
    tagline_zh_2: "我們帶你做大",
    positioning_en: "Taiwan's first operator-led syndicate. We're built to grow your revenue — from your first enterprise deal to nine figures — with 50+ operators who've already done it.",
    positioning_zh: "全台首創 Operator-Led 投資飛輪。我們為放大你的營收而生——從第一筆大廠訂單到億級規模，靠的是 50+ 位走過這條路的營運者。",
  ...
  operators: [
    {id:1, name:'James C.',    company:'Meta',      companyKey:'nexia',   color:'#3B82F6', title:'VP, Enterprise Solutions',        years:8,  focus:'Cloud · Enterprise SaaS', linkedin:'', fn:'Enterprise Sales', type:'Founding Council Member', visible:true},
    {id:2, name:'Michelle L.', company:'Meta',      companyKey:'nexia',   color:'#3B82F6', title:'Director, Global Strategic Accounts', years:6, focus:'Strategic Partnerships', linkedin:'', fn:'Enterprise Sales', type:'Founding Council Member', visible:true},
    {id:3, name:'Sarah K.',    company:'Meta',      companyKey:'nexia',   color:'#3B82F6', title:'VP, Strategic Partnerships APAC', years:7,  focus:'APAC · B2B SaaS', linkedin:'', fn:'Partnerships', type:'Founding Council Member', visible:true},
    {id:4, name:'Ryan H.',     company:'Meta',      companyKey:'nexia',   color:'#3B82F6', title:'Director, Cloud Business',        years:5,  focus:'Cloud Infrastructure', linkedin:'', fn:'Cloud & Infra', type:'Founding Council Member', visible:true},
    {id:5, name:'Amy T.',      company:'Meta',      companyKey:'nexia',   color:'#3B82F6', title:'VP, Business Development Asia',   years:9,  focus:'Market Expansion · Asia', linkedin:'', fn:'Growth & BD', type:'Founding Council Member', visible:true},
    {id:6, name:'Patrick L.',  company:'Oracle',    companyKey:'oracore', color:'#EF4444', title:'Director, Regional Sales APAC',   years:9,  focus:'Database · Enterprise', linkedin:'', fn:'Enterprise Sales', type:'Founding Council Member', visible:true},
    {id:7, name:'Wayne C.',    company:'Oracle',    companyKey:'oracore', color:'#EF4444', title:'VP, Database & Cloud Solutions',  years:11, focus:'Cloud Migration · SaaS', linkedin:'', fn:'Cloud & Infra', type:'Founding Council Member', visible:true},
    {id:8, name:'Yvonne M.',   company:'Oracle',    companyKey:'oracore', color:'#EF4444', title:'VP, Enterprise Accounts',         years:8,  focus:'Enterprise Accounts', linkedin:'', fn:'Enterprise Sales', type:'Founding Council Member', visible:true},
    {id:9, name:'David T.',    company:'Oracle',    companyKey:'oracore', color:'#EF4444', title:'Director, Channel Partners',      years:6,  focus:'Channel · Resellers', linkedin:'', fn:'Channel', type:'Founding Council Member', visible:true},
    {id:10,name:'Henry C.',    company:'Google',    companyKey:'globex',  color:'#8B5CF6', title:'VP, Cloud Infrastructure',        years:10, focus:'Cloud · AI/ML', linkedin:'', fn:'Cloud & Infra', type:'Founding Council Member', visible:true},
    {id:11,name:'Emma M.',     company:'Google',    companyKey:'globex',  color:'#8B5CF6', title:'Director, B2B Partnerships',      years:5,  focus:'B2B · Developer Tools', linkedin:'', fn:'Partnerships', type:'Funding Member (Council)', visible:true},
    {id:12,name:'Kevin W.',    company:'Google',    companyKey:'globex',  color:'#8B5CF6', title:'Director, Startup Ecosystem',     years:6,  focus:'Startups · GTM', linkedin:'', fn:'Growth & BD', type:'Funding Member (Council)', visible:true},
    {id:13,name:'Lisa N.',     company:'Google',    companyKey:'globex',  color:'#8B5CF6', title:'Director, Partner Strategy',      years:7,  focus:'Partner Ecosystem', linkedin:'', fn:'Partnerships', type:'Funding Member (Council)', visible:true},
    {id:14,name:'Ben K.',      company:'Google',    companyKey:'globex',  color:'#8B5CF6', title:'VP, Enterprise Sales APAC',       years:12, focus:'Enterprise Sales · APAC', linkedin:'', fn:'Enterprise Sales', type:'Funding Member (Council)', visible:true},
    {id:15,name:'Thomas C.',   company:'AWS',       companyKey:'acs',     color:'#0EA5E9', title:'VP, Startup Programs',            years:7,  focus:'Startups · Cloud Credits', linkedin:'', fn:'Growth & BD', type:'Funding Member (Council)', visible:true},
    {id:16,name:'Grace S.',    company:'AWS',       companyKey:'acs',     color:'#0EA5E9', title:'Director, Enterprise Solutions',  years:8,  focus:'Enterprise Solutions', linkedin:'', fn:'Enterprise Sales', type:'Funding Member (Council)', visible:true},
    {id:17,name:'Michael R.',  company:'AWS',       companyKey:'acs',     color:'#0EA5E9', title:'VP, Channel Partnerships',        years:10, focus:'Channel · ISV', linkedin:'', fn:'Channel', type:'Funding Member (Council)', visible:true},
