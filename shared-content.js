...
window.OS_CONTENT = {
  ...
  operators: [
    ...
    {id:2, name:'Michelle L.',company:'Microsoft',      confirmed:true, color:'#0078D4', companyKey:'partner', title:'Director, Global Strategic Accounts', years:22, img:2, focus:'Strategic Partnerships', linkedin:'', fn:'Enterprise Sales', type:'Founding Council', visible:true},
    ...
    {id:4, name:'Ryan H.',    company:'IBM',            confirmed:true, color:'#1F70C1', companyKey:'partner', title:'Director, Cloud Business',        years:24, img:4,  focus:'Enterprise · Cloud', linkedin:'', fn:'Cloud & Infra', type:'Founding Council', visible:true},
    {id:5, name:'Amy T.',     company:'Salesforce',     confirmed:true, color:'#00A1E0', companyKey:'partner', title:'VP, Business Development Asia',   years:21, img:5,  focus:'Market Expansion · Asia', linkedin:'', fn:'Growth & BD', type:'Founding Council', visible:true},
    {id:6, name:'Patrick L.', company:'UBS',            confirmed:true, color:'#E60028', companyKey:'partner', title:'Director, Regional Sales APAC',   years:19, img:6,  focus:'Financial · Enterprise', linkedin:'', fn:'Enterprise Sales', type:'Founding Council', visible:true},
    {id:7, name:'Wayne C.',   company:'GlobalFoundries',confirmed:true, color:'#E03C31', companyKey:'partner', title:'VP, Cloud & Solutions',          years:23, img:7,  focus:'Semiconductor · Enterprise', linkedin:'', fn:'Cloud & Infra', type:'Founding Council', visible:true},
    {id:8, name:'Yvonne M.',  company:'Sharp',          confirmed:true, color:'#BB0000', companyKey:'partner', title:'VP, Enterprise Accounts',        years:20, img:8,  focus:'Enterprise Accounts', linkedin:'', fn:'Enterprise Sales', type:'Founding Council', visible:true},
    {id:9, name:'David T.',   company:'Dentsu',         confirmed:true, color:'#2D2D2D', companyKey:'partner', title:'Director, Channel Partners',     years:25, img:9,  focus:'Media · Channel', linkedin:'', fn:'Channel', type:'Founding Council', visible:true},
    {id:10,name:'Henry C.',   company:'LINE',           confirmed:true, color:'#06C755', companyKey:'partner', title:'VP, Platform Partnerships',      years:22, img:10, focus:'Platform · APAC', linkedin:'', fn:'Cloud & Infra', type:'Founding Council', visible:true},
    {id:11,name:'Emma M.',    company:'IDC',            confirmed:true, color:'#0033A0', companyKey:'partner', title:'Director, B2B Partnerships',     years:18, img:11, focus:'Research · Advisory', linkedin:'', fn:'Partnerships', type:'Founding Council', visible:true},
    ...
    {id:13,name:'Lisa N.',    company:'iPassMoney',     confirmed:true, color:'#FF8800', companyKey:'partner', title:'Director, Partner Strategy',     years:24, img:14, focus:'Fintech · Partner', linkedin:'', fn:'Partnerships', type:'Founding Council', visible:true},
    {id:14,name:'Ben K.',     company:'TSMC',           confirmed:false,color:'#C8102E', companyKey:'potential',title:'VP, Enterprise Sales APAC',     years:19, img:15, focus:'Semiconductor · APAC', linkedin:'', fn:'Enterprise Sales', type:'Founding Member', visible:true},
    {id:15,name:'Thomas C.',  company:'Foxconn',        confirmed:false,color:'#003DA5', companyKey:'potential',title:'VP, Strategic Programs',        years:20, img:16, focus:'Manufacturing · Scale', linkedin:'', fn:'Growth & BD', type:'Founding Member', visible:true},
    {id:16,name:'Grace S.',   company:'MediaTek',       confirmed:false,color:'#EC6B23', companyKey:'potential',title:'Director, Enterprise Solutions',years:23, img:17, focus:'Chipset · Enterprise', linkedin:'', fn:'Enterprise Sales', type:'Founding Member', visible:true},
    {id:17,name:'Michael R.', company:'ASUS',           confirmed:false,color:'#00539B', companyKey:'potential',title:'VP, Channel Partnerships',      years:22, img:18, focus:'Channel · ISV', linkedin:'', fn:'Channel', type:'Founding Member', visible:true},
    {id:18,name:'Nancy P.',   company:'Acer',           confirmed:false,color:'#83B81A', companyKey:'potential',title:'Director, Enterprise Solutions',years:18, img:19, focus:'Enterprise Solutions', linkedin:'', fn:'Cloud & Infra', type:'Founding Member', visible:true},
    {id:19,name:'Frank Y.',   company:'Quanta',         confirmed:false,color:'#1A4F9C', companyKey:'potential',title:'VP, Digital Transformation',    years:21, img:20, focus:'Hardware · Cloud', linkedin:'', fn:'Growth & BD', type:'Founding Member', visible:true},
    {id:20,name:'Alex L.',    company:'Delta',          confirmed:false,color:'#00853F', companyKey:'potential',title:'Director, Enterprise APAC',     years:20, img:21, focus:'Energy · Enterprise', linkedin:'', fn:'Enterprise Sales', type:'Founding Member', visible:true},
